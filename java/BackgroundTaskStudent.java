 ...
 */
public class BackgroundTaskStudent extends AsyncTask<String,Void,String> {
    AlertDialog alertDialog;
    Context ctx;
    BackgroundTaskStudent(Context ctx)
    {
    ...
    protected String doInBackground(String... params) {
        ...
        String saveurl="http://10.101.237.71/~towfiqurrahman/Studentinfo.php";
        String logurl="http://10.101.237.71/~towfiqurrahman/login.php";
        ...
        if(method.equals("register"))
        {
            ...
            try {
                ...
                if(result != null){
                    ...
                    Intent intent = new Intent(ctx, StudentView.class);
    ...
    protected void onPostExecute(String result) {
        ...
        }else
        {
            ...
            Intent intent;
            intent = new Intent(ctx, StudentView.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            intent.putExtra("User Name:", result);
